...
const universityCards = [
    ...
    { organization: 'Innovation Labs', location: 'Nsukka, Enugu' },
                ...
                {universityCards.map((item, index) => (
                    <Card key={index} className="hover:shadow-lg transition-shadow rounded-2xl overflow-hidden pt-0 font-mono gap-3">
                        ...
                        <CardHeader className='flex items-start'>
                            <div>
                                <div className="w-10 h-10 rounded-full bg-[#89F336]" />
                            </div>
                            <div className='flex-1 flex flex-col'>
                                <CardTitle className="text-base">{item.organization}</CardTitle>
