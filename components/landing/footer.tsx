...
export function Footer() {
    ...
    return (
        <footer className="h-full bg-black text-white overflow-hidden relative">
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <LogoText className="h-fit w-full max-w-5xl text-white" />
            </div>
            <div className="container mx-auto p-10 sm:px-20 sm:py-15 relative z-10 bg-no-repeat">
                <div className="grid md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <span className="text-base opacity-90">{theme === 'dark' ? "Dark" : "Light"}</span>
                        </div>
                    </div>
                </div>
